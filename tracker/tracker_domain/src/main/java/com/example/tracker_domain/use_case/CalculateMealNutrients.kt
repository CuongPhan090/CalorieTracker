...
class CalculateMealNutrients (
    ...
    /**
     * bmr: Basal Metabolic Rate -> calculate how much calorie a person burns without doing anything
     */
    ...
    /**
     * What is the nutrition GOAL, and how much nutrition has been consumed on a specific meal type
     */
    data class Result(
        val carbsGoal: Int,
        val proteinGoal: Int,
